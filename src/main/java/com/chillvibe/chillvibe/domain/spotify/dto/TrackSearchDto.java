...
public class TrackSearchDto {
  ...
  private final String artist; // 아티스트 이름
  private final String thumbnailUrl; // 커버 이미지
  private final String previewUrl; // 미리듣기 URL (Null 처리 프론트엔드에서 완료)
  private final String duration; // 재생 시간

  // 생성자
  public TrackSearchDto(String id, String name, String artist,
      String thumbnailUrl, String previewUrl, Integer durationMS) {
    this.id = id;
    this.name = name;
    this.artist = artist;
